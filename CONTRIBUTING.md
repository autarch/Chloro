...
https://metacpan.org/release/Chloro

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Chloro
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Chloro
...
The code for this distribution is [hosted at GitHub](https://github.com/autarch/Chloro).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=Chloro)
or [via email](bug-chloro@rt.cpan.org.
